...
import { faListAlt, faHandshake, faCoins } from '@fortawesome/free-solid-svg-icons'; // Import necessary icons
import './services.css';
    ...
    <div id="services" className="section">
      ...
      <div className="services-container">
        <div className="service-box">
          ...
          <FontAwesomeIcon icon={faListAlt} size="2x" color="yellow" /> {/* Adjust size and color */}
          </div>
        ...
        <div className="service-box">
          <div className="service-icon">
            <FontAwesomeIcon icon={faHandshake} size="2x" color="yellow" />
          </div>
        ...
        <div className="service-box">
          <div className="service-icon">
            <FontAwesomeIcon icon={faCoins} size="2x" color="yellow" />
          </div>
